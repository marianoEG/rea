...
import { heightPercentageToDP, Size, widthPercentageToDP } from '../../utils/Size';
...
const SubEventItem = ({ item, onSelectItem, height = 300 }: Props) => {
                        ...
                        {showDefaultImage
                            ...
                            (
                                <DefaultImage
                                    ...
                                    text="No se encontró la imagen del subevento"
